...
class ORFRadioCollectionIE(ORFRadioBase):
    ...
    _TESTS = [{
        'url': 'https://sound.orf.at/collection/4/61201/die-kraft-des-wassers-in-den-fm4-field-recordings',
        'info_dict': {
            'id': '2572147',
        },
        'playlist': [{
            'md5': 'c6e540ce4af0331023c25d5fb332ac8c',
            'info_dict': {
                'id': '2024-05-30_1300_tl_54_7DaysThu4_153677',
                'ext': 'mp3',
                'title': 'FM4 Field Records',
                'description': 'Gespräche mitten im Geschehen',
                'timestamp': 1717066979,
                'upload_date': '20240530',
                'uploader': 'fm4',
            },
        }],
